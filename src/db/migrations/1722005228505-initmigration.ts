...
export class Initmigration1722005228505 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."game_status_enum" AS ENUM('active', 'inactive', 'done', 'paused')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."game_boardposition_enum" AS ENUM('random', 'sequential')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('admin', 'player', 'sponsor')`,
    );
    await queryRunner.query(
